...
const footerLinks = {
  Produit: ["Fonctionnalités", "Tarifs", "Securité", "Feuille de route", "Journal des modifications"],
  Entreprise: ["À propos", "Blog", "Carrières", "Press", "Partenaires"],
  Ressources: [
    "Documentation",
    "Centre d'aide",
    "Communauté",
  ...
  Légal: ["Confidentialité", "Conditions", "Politique de cookies", "Licenses", "Conformité"],
};
        ...
        <div className="hidden sm:grid sm:grid-cols-3 lg:grid-cols-6 gap-6 sm:gap-8 lg:gap-12 mb-8 sm:mb-12">
          <div className="col-span-1 sm:col-span-3 lg:col-span-2 text-center sm:text-left">
            ...
            <p className="text-gray-400 mb-4 sm:mb-6 max-w-xs mx-auto sm:mx-0 text-sm sm:text-base">
              Transformez votre workflow grâce à l'IA et l'automatisation. Conçu pour les équipes modernes.
            </p>
        ...
        <div className="pt-6 sm:pt-8 border-t-0 sm:border-t border-slate-800">
          <div className="flex flex-col sm:flex-row justify-between items-center space-y-3 sm:space-y-0">
            <p className="text-gray-400 text-xs sm:text-sm">
              © 2025 DevFluent. Tous droits réservés.
            </p>
